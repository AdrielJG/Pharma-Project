...
const Dashboard = () => {
  ...
  const handleDownloadReport = async () => {
    ...
    try {
        ...
        addSection('Total Revenue', `Amount: ${formatCurrency(transactionData.totalQuotation)}`);
        addSection('Medicines Available', `Count: ${inventoryCount}`);
        addSection('Transaction Summary', `Total Transactions Value: ${formatCurrency(transactionData.totalQuotation)}\nCompleted Orders: ${transactionData.transactionCount}`);
