    ...
    try:
        ...
        <body>
            <div class="container">
                ...
                <p>Dear Subscriber,</p>
                <p>We’re excited to bring you the latest news and updates in our monthly newsletter:</p>
                <ul>
                    <li>🚀 <strong>New Feature:</strong> Real-time supply chain tracking for enhanced transparency.</li>
                    <li>📅 <strong>Upcoming Webinar:</strong> Join us to explore blockchain innovations in pharmaceuticals.</li>
                    <li>📰 <strong>Industry Insights:</strong> Stay ahead with the latest trends and developments.</li>
                </ul>
